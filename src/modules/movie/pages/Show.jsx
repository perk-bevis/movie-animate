...
const Show = ({ title }) => {
  ...
  const {movieShow, loading } = useData(currentPage);
  if (loading) {
    return (
        ...
        <div className="max-w-screen-xl mx-auto">
              ...
              <div key={show._id} className="group cursor-pointer">
                <Link to={`/phim/${show.slug}/${show._id}`}>
                  <div className="overflow-hidden rounded-lg">
                    <img
                      src={`${import.meta.env.VITE_IMG_URL}${show.poster_url}`}
          ...
          <div className="mt-8 flex flex-col sm:flex-row justify-center sm:justify-between items-center text-sm text-gray-300">
            <div className="flex items-center space-x-2 mb-4 sm:mb-0">
              <a
                href="#"
                className="px-3 py-1 rounded-md border border-gray-600 hover:bg-gray-700"
              >
                1
              </a>
              <a
                href="#"
                className="px-3 py-1 rounded-md bg-blue-600 text-white border border-blue-600"
              >
                2
              </a>
              <a
